...
- Tweaked API.getFunction to allow [method] parameter to be optional.  Also changed function to
  throw if passed arguments that don't map to an actual function.
