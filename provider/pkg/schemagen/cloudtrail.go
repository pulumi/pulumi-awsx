...
// Package gen provides schema generation utilities for the awsx provider.
package gen
					...
					Properties: map[string]schema.PropertySpec{
						...
						"retentionInDays": {
							Description: "Specifies the number of days you want to retain log events " +
								"in the specified log group. Possible values are: 1, 3, 5, 7, " +
								"14, 30, 60, 90, 120, 150, 180, 365, 400, 545, 731, 1827, 36" +
								"53, and 0. If you select 0, the events in the log group are " +
						...
						"tags": {
							...
							Description: "A map of tags to assign to the resource. If configured with " +
								"provider defaultTags present, tags with matching keys will " +
