...
if not MYPY:
    class NatGatewayConfigurationArgsDict(TypedDict):
        ...
        """
        elastic_ip_allocation_ids: NotRequired[Sequence[pulumi.Input[builtins.str]]]
        """
...
class NatGatewayConfigurationArgs:
    def __init__(__self__, *,
                 strategy: 'NatGatewayStrategy',
                 elastic_ip_allocation_ids: Optional[Sequence[pulumi.Input[builtins.str]]] = None):
        """
        Configuration for NAT Gateways.
        :param 'NatGatewayStrategy' strategy: The strategy for deploying NAT Gateways.
        :param Sequence[pulumi.Input[builtins.str]] elastic_ip_allocation_ids: A list of EIP allocation IDs to assign to the NAT Gateways. Optional. If specified, the number of supplied values must match the chosen strategy (either one, or the number of availability zones).
        """
    ...
    def elastic_ip_allocation_ids(self) -> Optional[Sequence[pulumi.Input[builtins.str]]]:
        """
        A list of EIP allocation IDs to assign to the NAT Gateways. Optional. If specified, the number of supplied values must match the chosen strategy (either one, or the number of availability zones).
        """
    ...
    def elastic_ip_allocation_ids(self, value: Optional[Sequence[pulumi.Input[builtins.str]]]):
...
if not MYPY:
    class SubnetSpecArgsDict(TypedDict):
        ...
        """
        cidr_mask: NotRequired[builtins.int]
        """
...
class SubnetSpecArgs:
    def __init__(__self__, *,
        ...
        :param builtins.int size: Optional size of the subnet's CIDR block - the number of hosts. This value must be a power of 2 (e.g. 256, 512, 1024, etc.). This is optional, the default value is inferred from the `cidrMask`, `cidrBlocks` or based on an even distribution of available space from the VPC's CIDR block after being divided evenly by availability zone.
    ...
    def cidr_blocks(self) -> Optional[Sequence[builtins.str]]:
        """
        An optional list of CIDR blocks to assign to the subnet spec for each AZ. If specified, the count must match the number of AZs being used for the VPC, and must also be specified for all other subnet specs.
        """
    ...
    @cidr_blocks.setter
    def cidr_blocks(self, value: Optional[Sequence[builtins.str]]):
        pulumi.set(self, "cidr_blocks", value)

    @property
    @pulumi.getter(name="cidrMask")
    def cidr_mask(self) -> Optional[builtins.int]:
        """
        The netmask for the subnet's CIDR block. This is optional, the default value is inferred from the `cidrMask`, `cidrBlocks` or based on an even distribution of available space from the VPC's CIDR block after being divided evenly by availability zone.
        """
    ...
    @cidr_mask.setter
    def cidr_mask(self, value: Optional[builtins.int]):
    ...
    @size.setter
    def size(self, value: Optional[builtins.int]):
...
if not MYPY:
    class VpcEndpointSpecArgsDict(TypedDict):
        ...
        """
        auto_accept: NotRequired[builtins.bool]
        """
        ...
        """
        private_dns_enabled: NotRequired[builtins.bool]
        """
...
class VpcEndpointSpecArgs:
    def __init__(__self__, *,
        ...
        :param builtins.str service_name: The service name. For AWS services the service name is usually in the form `com.amazonaws.<region>.<service>` (the SageMaker Notebook service is an exception to this rule, the service name is in the form `aws.sagemaker.<region>.notebook`).
        :param builtins.bool auto_accept: Accept the VPC endpoint (the VPC endpoint and service need to be in the same AWS account).
    ...
    @auto_accept.setter
    def auto_accept(self, value: Optional[builtins.bool]):
    ...
    def private_dns_enabled(self) -> Optional[builtins.bool]:
        """
        Whether or not to associate a private hosted zone with the specified VPC. Applicable for endpoints of type Interface. Defaults to `false`.
        """
    ...
    def private_dns_enabled(self, value: Optional[builtins.bool]):
