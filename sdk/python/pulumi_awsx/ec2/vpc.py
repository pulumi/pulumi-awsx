...
class VpcArgs:
    def __init__(__self__, *,
                 ...
                 subnet_naming: Optional['SubnetNamingStrategy'] = None,
        ...
        :param 'SubnetNamingStrategy' subnet_naming: The strategy to use when naming the VPC's subnets and their associated route tables, route table associations and routes. Optional. Defaults to `Legacy`.
        ...
        if subnet_naming is not None:
            pulumi.set(__self__, "subnet_naming", subnet_naming)
    ...
    @_builtins.property
    @pulumi.getter(name="subnetNaming")
    def subnet_naming(self) -> Optional['SubnetNamingStrategy']:
        """
        ...
        """
        return pulumi.get(self, "subnet_naming")

    @subnet_naming.setter
    def subnet_naming(self, value: Optional['SubnetNamingStrategy']):
        pulumi.set(self, "subnet_naming", value)
...
class Vpc(pulumi.ComponentResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is not None:
            ...
            __props__.__dict__["subnet_naming"] = subnet_naming
