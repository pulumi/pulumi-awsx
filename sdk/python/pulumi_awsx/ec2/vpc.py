...
class VpcArgs:
    def __init__(__self__, *,
                 ...
                 availability_zone_cidr_mask: Optional[builtins.int] = None,
                 availability_zone_names: Optional[Sequence[builtins.str]] = None,
        ...
        :param builtins.int availability_zone_cidr_mask: The netmask for each available zone to be aligned to. This is optional, the default value is inferred based on an even distribution of available space from the VPC's CIDR block after being divided evenly by the number of availability zones.
        :param Sequence[builtins.str] availability_zone_names: A list of availability zone names to which the subnets defined in subnetSpecs will be deployed. Optional, defaults to the first 3 AZs in the current region.
        :param builtins.str cidr_block: The CIDR block for the VPC. Optional. Defaults to 10.0.0.0/16.
    ...
    def availability_zone_cidr_mask(self) -> Optional[builtins.int]:
        """
    ...
    def availability_zone_cidr_mask(self, value: Optional[builtins.int]):
        pulumi.set(self, "availability_zone_cidr_mask", value)

    @property
    @pulumi.getter(name="availabilityZoneNames")
    def availability_zone_names(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def availability_zone_names(self, value: Optional[Sequence[builtins.str]]):
    ...
    @cidr_block.setter
    def cidr_block(self, value: Optional[builtins.str]):
    ...
    def number_of_availability_zones(self) -> Optional[builtins.int]:
        """
    ...
    def number_of_availability_zones(self, value: Optional[builtins.int]):
...
class Vpc(pulumi.ComponentResource):
    ...
    def isolated_subnet_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
    ...
    def private_subnet_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        return pulumi.get(self, "private_subnet_ids")

    @property
    @pulumi.getter(name="publicSubnetIds")
    def public_subnet_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
