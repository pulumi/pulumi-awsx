...
class HttpApiArgs:
    def __init__(__self__, *,
                 routes: pulumi.Input[Mapping[str, pulumi.Input['HttpRouteArgs']]],
                 api_key_selection_expression: Optional[pulumi.Input[str]] = None,
                 authorizers: Optional[pulumi.Input[Mapping[str, pulumi.Input['HttpAuthorizerArgs']]]] = None,
                 ...
                 domain_mappings: Optional[pulumi.Input[Mapping[str, pulumi.Input['DomainMappingArgs']]]] = None,
                 fail_on_warnings: Optional[pulumi.Input[bool]] = None,
                 integrations: Optional[pulumi.Input[Mapping[str, pulumi.Input['HttpIntegrationArgs']]]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 route_selection_expression: Optional[pulumi.Input[str]] = None,
                 stages: Optional[pulumi.Input[Mapping[str, pulumi.Input['HttpStageArgs']]]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 version: Optional[pulumi.Input[str]] = None):
        """
        The set of arguments for constructing a HttpApi resource.
        :param pulumi.Input[Mapping[str, pulumi.Input['HttpRouteArgs']]] routes: The routes for the HTTP API.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input['HttpAuthorizerArgs']]] authorizers: The authorizers for the HTTP API routes.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input['DomainMappingArgs']]] domain_mappings: The domain names for the HTTP API.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input['HttpIntegrationArgs']]] integrations: The integrations for the HTTP API routes.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input['HttpStageArgs']]] stages: The deployment stages for the HTTP API.
    ...
    @property
    @pulumi.getter
    def routes(self) -> pulumi.Input[Mapping[str, pulumi.Input['HttpRouteArgs']]]:
        """
    ...
    @routes.setter
    def routes(self, value: pulumi.Input[Mapping[str, pulumi.Input['HttpRouteArgs']]]):
    ...
    @property
    @pulumi.getter
    def authorizers(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input['HttpAuthorizerArgs']]]]:
        """
    ...
    @authorizers.setter
    def authorizers(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input['HttpAuthorizerArgs']]]]):
    ...
    def domain_mappings(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input['DomainMappingArgs']]]]:
        """
    ...
    def domain_mappings(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input['DomainMappingArgs']]]]):
    ...
    @property
    @pulumi.getter
    def integrations(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input['HttpIntegrationArgs']]]]:
        """
    ...
    @integrations.setter
    def integrations(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input['HttpIntegrationArgs']]]]):
    ...
    @property
    @pulumi.getter
    def stages(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input['HttpStageArgs']]]]:
        """
    ...
    @stages.setter
    def stages(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input['HttpStageArgs']]]]):
...
class HttpApi(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 api_key_selection_expression: Optional[pulumi.Input[str]] = None,
                 authorizers: Optional[pulumi.Input[Mapping[str, pulumi.Input[pulumi.InputType['HttpAuthorizerArgs']]]]] = None,
                 body: Optional[pulumi.Input[str]] = None,
                 cors_configuration: Optional[pulumi.Input[pulumi.InputType['pulumi_aws.apigatewayv2.ApiCorsConfigurationArgs']]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 disable_execute_api_endpoint: Optional[pulumi.Input[bool]] = None,
                 domain_mappings: Optional[pulumi.Input[Mapping[str, pulumi.Input[pulumi.InputType['DomainMappingArgs']]]]] = None,
                 fail_on_warnings: Optional[pulumi.Input[bool]] = None,
                 integrations: Optional[pulumi.Input[Mapping[str, pulumi.Input[pulumi.InputType['HttpIntegrationArgs']]]]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 route_selection_expression: Optional[pulumi.Input[str]] = None,
                 routes: Optional[pulumi.Input[Mapping[str, pulumi.Input[pulumi.InputType['HttpRouteArgs']]]]] = None,
                 stages: Optional[pulumi.Input[Mapping[str, pulumi.Input[pulumi.InputType['HttpStageArgs']]]]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
                 version: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[str] api_key_selection_expression: An [API key selection expression](https://docs.aws.amazon.com/apigateway/latest/developerguide/apigateway-websocket-api-selection-expressions.html#apigateway-websocket-api-apikey-selection-expressions).
               Valid values: `$context.authorizer.usageIdentifierKey`, `$request.header.x-api-key`. Defaults to `$request.header.x-api-key`.
               Applicable for WebSocket APIs.
        :param pulumi.Input[Mapping[str, pulumi.Input[pulumi.InputType['HttpAuthorizerArgs']]]] authorizers: The authorizers for the HTTP API routes.
        :param pulumi.Input[str] body: An OpenAPI specification that defines the set of routes and integrations to create as part of the HTTP APIs. Supported only for HTTP APIs.
        ...
        :param pulumi.Input[bool] disable_execute_api_endpoint: Whether clients can invoke the API by using the default `execute-api` endpoint.
               By default, clients can invoke the API with the default `{api_id}.execute-api.{region}.amazonaws.com endpoint`.
               To require that clients use a custom domain name to invoke the API, disable the default endpoint.
        :param pulumi.Input[Mapping[str, pulumi.Input[pulumi.InputType['DomainMappingArgs']]]] domain_mappings: The domain names for the HTTP API.
        :param pulumi.Input[bool] fail_on_warnings: Whether warnings should return an error while API Gateway is creating or updating the resource using an OpenAPI specification. Defaults to `false`. Applicable for HTTP APIs.
        :param pulumi.Input[Mapping[str, pulumi.Input[pulumi.InputType['HttpIntegrationArgs']]]] integrations: The integrations for the HTTP API routes.
        :param pulumi.Input[str] name: Name of the API. Must be less than or equal to 128 characters in length.
        :param pulumi.Input[str] route_selection_expression: The [route selection expression](https://docs.aws.amazon.com/apigateway/latest/developerguide/apigateway-websocket-api-selection-expressions.html#apigateway-websocket-api-route-selection-expressions) for the API.
               Defaults to `$request.method $request.path`.
        :param pulumi.Input[Mapping[str, pulumi.Input[pulumi.InputType['HttpRouteArgs']]]] routes: The routes for the HTTP API.
        :param pulumi.Input[Mapping[str, pulumi.Input[pulumi.InputType['HttpStageArgs']]]] stages: The deployment stages for the HTTP API.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] tags: Map of tags to assign to the API. If configured with a provider `default_tags` configuration block present, tags with matching keys will overwrite those defined at the provider-level.
        :param pulumi.Input[str] version: Version identifier for the API. Must be between 1 and 64 characters in length.
        """
        ...
