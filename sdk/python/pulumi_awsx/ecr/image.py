...
class ImageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] dockerfile: dockerfile may be used to override the default Dockerfile name and/or location.  By default, it is assumed to be a file named Dockerfile in the root of the build context.
        :param pulumi.Input[_builtins.str] image_name: Custom name for the underlying Docker image resource. If omitted, the image tag assigned by the provider will be used
        :param pulumi.Input[_builtins.str] image_tag: Custom image tag for the resulting docker image. If omitted a random string will be used
        ...
        :param pulumi.Input[_builtins.str] registry_id: ID of the ECR registry in which to store the image.  If not provided, this will be inferred from the repository URL)
