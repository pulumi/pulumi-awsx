...
class ImageArgs:
    def __init__(__self__, *,
                 ...
                 builder_version: Optional[pulumi.Input['pulumi_docker.BuilderVersion']] = None,
        ...
        :param pulumi.Input['pulumi_docker.BuilderVersion'] builder_version: The version of the Docker builder
    ...
    def builder_version(self) -> Optional[pulumi.Input['pulumi_docker.BuilderVersion']]:
        """
    ...
    def builder_version(self, value: Optional[pulumi.Input['pulumi_docker.BuilderVersion']]):
