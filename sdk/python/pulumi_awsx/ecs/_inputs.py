...
if not MYPY:
    class EC2ServiceTaskDefinitionArgsDict(TypedDict):
        ...
        """
        enable_fault_injection: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        ipc_mode: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        pid_mode: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        Will be created automatically if not defined.
        """
        track_latest: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class TaskDefinitionContainerDefinitionArgs:
    def __init__(__self__, *,
        ...
        """
        List of container definitions that are passed to the Docker daemon on a container instance
        :param pulumi.Input[builtins.str] image: The image used to start a container. This string is passed directly to the Docker daemon.
        :param pulumi.Input[builtins.str] name: The name of a container. Up to 255 letters (uppercase and lowercase), numbers, hyphens, and underscores are allowed
        ...
        :param pulumi.Input[builtins.int] memory: The amount (in MiB) of memory to present to the container. If your container attempts to exceed the memory specified here, the container is killed.
...
class TaskDefinitionHealthCheckArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] interval: The time period in seconds between each health check execution. You may specify between 5 and 300 seconds. The default value is 30 seconds.
        :param pulumi.Input[builtins.int] retries: The number of times to retry a failed health check before the container is considered unhealthy. You may specify between 1 and 10 retries. The default value is three retries.
        :param pulumi.Input[builtins.int] start_period: The optional grace period within which to provide containers time to bootstrap before failed health checks count towards the maximum number of retries. You may specify between 0 and 300 seconds. The startPeriod is disabled by default.
        :param pulumi.Input[builtins.int] timeout: The time period in seconds to wait for a health check to succeed before it is considered a failure. You may specify between 2 and 60 seconds. The default value is 5 seconds.
        """
        if command is not None:
            pulumi.set(__self__, "command", command)
