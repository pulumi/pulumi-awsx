...
class FargateServiceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] desired_count: Number of instances of the task definition to place and keep running. Defaults to 1. Do not specify if using the `DAEMON` scheduling strategy.
    ...
    def continue_before_steady_state(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def continue_before_steady_state(self, value: Optional[pulumi.Input[builtins.bool]]):
