...
class EC2Service(pulumi.ComponentResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            EC2ServiceArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is not None:
            ...
            if task_definition_args is not None and not isinstance(task_definition_args, EC2ServiceTaskDefinitionArgs):
                task_definition_args = task_definition_args or {}
                def _setter(key, value):
                    task_definition_args[key] = value
                EC2ServiceTaskDefinitionArgs._configure(_setter, **task_definition_args)
