...
class BucketArgs:
    def __init__(__self__, *,
        ...
        if object_lock_configuration is not None:
            warnings.warn("""object_lock_configuration is deprecated. Use the top-level parameter<span pulumi-lang-nodejs=\" objectLockEnabled \" pulumi-lang-dotnet=\" ObjectLockEnabled \" pulumi-lang-go=\" objectLockEnabled \" pulumi-lang-python=\" object_lock_enabled \" pulumi-lang-yaml=\" objectLockEnabled \" pulumi-lang-java=\" objectLockEnabled \"> objectLockEnabled </span>and the<span pulumi-lang-nodejs=\" aws.s3.BucketObjectLockConfiguration \" pulumi-lang-dotnet=\" aws.s3.BucketObjectLockConfiguration \" pulumi-lang-go=\" s3.BucketObjectLockConfiguration \" pulumi-lang-python=\" s3.BucketObjectLockConfiguration \" pulumi-lang-yaml=\" aws.s3.BucketObjectLockConfiguration \" pulumi-lang-java=\" aws.s3.BucketObjectLockConfiguration \"> aws.s3.BucketObjectLockConfiguration </span>resource instead.""", DeprecationWarning)
...
class SecurityGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] tags: Map of tags to assign to the resource. If configured with a provider <span pulumi-lang-nodejs="`defaultTags`" pulumi-lang-dotnet="`DefaultTags`" pulumi-lang-go="`defaultTags`" pulumi-lang-python="`default_tags`" pulumi-lang-yaml="`defaultTags`" pulumi-lang-java="`defaultTags`">`defaultTags`</span> configuration block present, tags with matching keys will overwrite those defined at the provider-level.
