...
class NetworkLoadBalancerArgs:
    def __init__(__self__, *,
                 access_logs: pulumi.Input[Optional['pulumi_aws.lb.LoadBalancerAccessLogsArgs']] = None,
                 client_keep_alive: pulumi.Input[Optional[_builtins.int]] = None,
                 connection_logs: pulumi.Input[Optional['pulumi_aws.lb.LoadBalancerConnectionLogsArgs']] = None,
                 customer_owned_ipv4_pool: pulumi.Input[Optional[_builtins.str]] = None,
                 default_target_group: Optional['TargetGroupArgs'] = None,
                 default_target_group_port: pulumi.Input[Optional[_builtins.int]] = None,
                 ...
                 health_check_logs: pulumi.Input[Optional['pulumi_aws.lb.LoadBalancerHealthCheckLogsArgs']] = None,
                 ...
                 ipam_pools: pulumi.Input[Optional['pulumi_aws.lb.LoadBalancerIpamPoolsArgs']] = None,
                 listener: Optional['ListenerArgs'] = None,
                 listeners: Optional[Sequence['ListenerArgs']] = None,
                 minimum_load_balancer_capacity: pulumi.Input[Optional['pulumi_aws.lb.LoadBalancerMinimumLoadBalancerCapacityArgs']] = None,
                 ...
                 subnet_mappings: pulumi.Input[Optional[Sequence[pulumi.Input['pulumi_aws.lb.LoadBalancerSubnetMappingArgs']]]] = None,
                 subnets: pulumi.Input[Optional[Sequence[pulumi.Input['pulumi_aws.ec2.Subnet']]]] = None,
        ...
        :param pulumi.Input['pulumi_aws.lb.LoadBalancerHealthCheckLogsArgs'] health_check_logs: Health Check Logs block. See below. Only valid for Load Balancers of type `application`.
    ...
    def access_logs(self) -> pulumi.Input[Optional['pulumi_aws.lb.LoadBalancerAccessLogsArgs']]:
        """
    ...
    @access_logs.setter
    def access_logs(self, value: pulumi.Input[Optional['pulumi_aws.lb.LoadBalancerAccessLogsArgs']]):
    ...
    def connection_logs(self) -> pulumi.Input[Optional['pulumi_aws.lb.LoadBalancerConnectionLogsArgs']]:
        """
    ...
    def connection_logs(self, value: pulumi.Input[Optional['pulumi_aws.lb.LoadBalancerConnectionLogsArgs']]):
    ...
    def default_target_group_port(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def default_target_group_port(self, value: pulumi.Input[Optional[_builtins.int]]):
    ...
    def health_check_logs(self) -> pulumi.Input[Optional['pulumi_aws.lb.LoadBalancerHealthCheckLogsArgs']]:
        """
    ...
    def health_check_logs(self, value: pulumi.Input[Optional['pulumi_aws.lb.LoadBalancerHealthCheckLogsArgs']]):
    ...
    def ipam_pools(self) -> pulumi.Input[Optional['pulumi_aws.lb.LoadBalancerIpamPoolsArgs']]:
        """
    ...
    @ipam_pools.setter
    def ipam_pools(self, value: pulumi.Input[Optional['pulumi_aws.lb.LoadBalancerIpamPoolsArgs']]):
    ...
    def minimum_load_balancer_capacity(self) -> pulumi.Input[Optional['pulumi_aws.lb.LoadBalancerMinimumLoadBalancerCapacityArgs']]:
        """
    ...
    def minimum_load_balancer_capacity(self, value: pulumi.Input[Optional['pulumi_aws.lb.LoadBalancerMinimumLoadBalancerCapacityArgs']]):
    ...
    def subnet_mappings(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['pulumi_aws.lb.LoadBalancerSubnetMappingArgs']]]]:
        """
    ...
    def subnet_mappings(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['pulumi_aws.lb.LoadBalancerSubnetMappingArgs']]]]):
        pulumi.set(self, "subnet_mappings", value)

    @_builtins.property
    @pulumi.getter
    def subnets(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['pulumi_aws.ec2.Subnet']]]]:
        """
    ...
    @subnets.setter
    def subnets(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['pulumi_aws.ec2.Subnet']]]]):
...
class NetworkLoadBalancer(pulumi.ComponentResource):
    ...
    def __init__(__self__,
                 ...
                 access_logs: pulumi.Input[Optional[pulumi.InputType['pulumi_aws.lb.LoadBalancerAccessLogsArgs']]] = None,
                 client_keep_alive: pulumi.Input[Optional[_builtins.int]] = None,
                 connection_logs: pulumi.Input[Optional[pulumi.InputType['pulumi_aws.lb.LoadBalancerConnectionLogsArgs']]] = None,
                 customer_owned_ipv4_pool: pulumi.Input[Optional[_builtins.str]] = None,
                 ...
                 enable_zonal_shift: pulumi.Input[Optional[_builtins.bool]] = None,
                 enforce_security_group_inbound_rules_on_private_link_traffic: pulumi.Input[Optional[_builtins.str]] = None,
                 health_check_logs: pulumi.Input[Optional[pulumi.InputType['pulumi_aws.lb.LoadBalancerHealthCheckLogsArgs']]] = None,
                 idle_timeout: pulumi.Input[Optional[_builtins.int]] = None,
                 internal: pulumi.Input[Optional[_builtins.bool]] = None,
                 ip_address_type: pulumi.Input[Optional[_builtins.str]] = None,
                 ipam_pools: pulumi.Input[Optional[pulumi.InputType['pulumi_aws.lb.LoadBalancerIpamPoolsArgs']]] = None,
                 ...
                 minimum_load_balancer_capacity: pulumi.Input[Optional[pulumi.InputType['pulumi_aws.lb.LoadBalancerMinimumLoadBalancerCapacityArgs']]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 name_prefix: pulumi.Input[Optional[_builtins.str]] = None,
                 preserve_host_header: pulumi.Input[Optional[_builtins.bool]] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
                 ...
                 security_groups: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 subnet_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 subnet_mappings: pulumi.Input[Optional[Sequence[pulumi.Input[pulumi.InputType['pulumi_aws.lb.LoadBalancerSubnetMappingArgs']]]]] = None,
                 subnets: pulumi.Input[Optional[Sequence[pulumi.Input['pulumi_aws.ec2.Subnet']]]] = None,
                 tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 xff_header_processing_mode: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        ...
        :param pulumi.Input[_builtins.bool] enable_zonal_shift: Whether zonal shift is enabled. Defaults to `false`.
        :param pulumi.Input[_builtins.str] enforce_security_group_inbound_rules_on_private_link_traffic: Whether inbound security group rules are enforced for traffic originating from a PrivateLink. Only valid for Load Balancers of type `network`. The possible values are `on` and `off`.
        :param pulumi.Input[pulumi.InputType['pulumi_aws.lb.LoadBalancerHealthCheckLogsArgs']] health_check_logs: Health Check Logs block. See below. Only valid for Load Balancers of type `application`.
        :param pulumi.Input[_builtins.int] idle_timeout: Time in seconds that the connection is allowed to be idle. Only valid for Load Balancers of type `application`. Default: 60.
        :param pulumi.Input[_builtins.bool] internal: If true, the LB will be internal. Defaults to `false`.
        :param pulumi.Input[_builtins.str] ip_address_type: Type of IP addresses used by the subnets for your load balancer. The possible values depend upon the load balancer type: `ipv4` (all load balancer types), `dualstack` (all load balancer types), and `dualstack-without-public-ipv4` (type `application` only).
