...
class NetworkLoadBalancerArgs:
    def __init__(__self__, *,
                 ...
                 default_target_group_port: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.int] default_target_group_port: Port to use to connect with the target. Valid values are ports 1-65535. Defaults to 80.
    ...
    def default_target_group_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def default_target_group_port(self, value: Optional[pulumi.Input[builtins.int]]):
