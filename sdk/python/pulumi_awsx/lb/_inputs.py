...
if not MYPY:
    class ListenerArgsDict(TypedDict):
        ...
        ```
        """
        alpn_policy: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ListenerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] certificate_arn: ARN of the default SSL server certificate. Exactly one certificate is required if the protocol is HTTPS. For adding additional SSL certificates, see the `aws.lb.ListenerCertificate` resource.
...
if not MYPY:
    class TargetGroupArgsDict(TypedDict):
        ...
        ```
        """
        connection_termination: NotRequired[pulumi.Input[builtins.bool]]
        """
        Whether to terminate connections at the end of the deregistration timeout on Network Load Balancers. See [doc](https://docs.aws.amazon.com/elasticloadbalancing/latest/network/load-balancer-target-groups.html#deregistration-delay) for more information. Default is `false`.
        """
        deregistration_delay: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        lambda_multi_value_headers_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        Whether the request and response headers exchanged between the load balancer and the Lambda function include arrays of values or strings. Only applies when `target_type` is `lambda`. Default is `false`.
        """
        load_balancing_algorithm_type: NotRequired[pulumi.Input[builtins.str]]
        """
        Determines how the load balancer selects targets when routing requests. Only applicable for Application Load Balancer Target Groups. The value is `round_robin`, `least_outstanding_requests`, or `weighted_random`. The default is `round_robin`.
        """
        load_balancing_anomaly_mitigation: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        load_balancing_cross_zone_enabled: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        preserve_client_ip: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        proxy_protocol_v2: NotRequired[pulumi.Input[builtins.bool]]
        """
