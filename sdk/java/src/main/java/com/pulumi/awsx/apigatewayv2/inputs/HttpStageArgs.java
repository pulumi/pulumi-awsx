...
public final class HttpStageArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private HttpStageArgs(HttpStageArgs $) {
    ...
    public static Builder builder(HttpStageArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(HttpStageArgs defaults) {
            $ = new HttpStageArgs(Objects.requireNonNull(defaults));
        }
