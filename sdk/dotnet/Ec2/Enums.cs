...
namespace Pulumi.Awsx.Ec2
{
    ...
    /// </summary>
    [EnumType]
    public readonly struct VpcEndpointStrategy : IEquatable<VpcEndpointStrategy>
    {
        private readonly string _value;

        private VpcEndpointStrategy(string value)
        {
            _value = value ?? throw new ArgumentNullException(nameof(value));
        }
        ...
        /// </summary>
        public static VpcEndpointStrategy Legacy { get; } = new VpcEndpointStrategy("Legacy");
        /// <summary>
        /// Fill omitted VPC endpoint fields from resources generated by this VPC component.
        /// </summary>
        public static VpcEndpointStrategy Auto { get; } = new VpcEndpointStrategy("Auto");

        public static bool operator ==(VpcEndpointStrategy left, VpcEndpointStrategy right) => left.Equals(right);
        public static bool operator !=(VpcEndpointStrategy left, VpcEndpointStrategy right) => !left.Equals(right);

        public static explicit operator string(VpcEndpointStrategy value) => value._value;

        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object? obj) => obj is VpcEndpointStrategy other && Equals(other);
        public bool Equals(VpcEndpointStrategy other) => string.Equals(_value, other._value, StringComparison.Ordinal);
