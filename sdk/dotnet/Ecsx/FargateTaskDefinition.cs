...
namespace Pulumi.Awsx.Ecsx
{
    ...
    /// </summary>
    [AwsxResourceType("awsx:ecsx:FargateTaskDefinition")]
    public partial class FargateTaskDefinition : Pulumi.ComponentResource
    {
        ...
        public FargateTaskDefinition(string name, FargateTaskDefinitionArgs? args = null, ComponentResourceOptions? options = null)
            : base("awsx:ecsx:FargateTaskDefinition", name, args ?? new FargateTaskDefinitionArgs(), MakeResourceOptions(options, ""), remote: true)
        {
        }
