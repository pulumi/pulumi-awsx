...
export class ApplicationLoadBalancer extends pulumi.ComponentResource {
     ...
     */
    declare public readonly defaultSecurityGroup: pulumi.Output<pulumiAws.ec2.SecurityGroup | undefined>;
    /**
...
export interface ApplicationLoadBalancerArgs {
     ...
     */
    accessLogs?: pulumi.Input<pulumiAws.types.input.lb.LoadBalancerAccessLogs | undefined>;
    /**
     ...
     */
    connectionLogs?: pulumi.Input<pulumiAws.types.input.lb.LoadBalancerConnectionLogs | undefined>;
    /**
     ...
     */
    defaultTargetGroupPort?: pulumi.Input<number | undefined>;
    /**
     ...
     */
    healthCheckLogs?: pulumi.Input<pulumiAws.types.input.lb.LoadBalancerHealthCheckLogs | undefined>;
    /**
     ...
     */
    ipamPools?: pulumi.Input<pulumiAws.types.input.lb.LoadBalancerIpamPools | undefined>;
    /**
     ...
     */
    minimumLoadBalancerCapacity?: pulumi.Input<pulumiAws.types.input.lb.LoadBalancerMinimumLoadBalancerCapacity | undefined>;
    /**
     ...
     */
    subnetMappings?: pulumi.Input<pulumi.Input<pulumiAws.types.input.lb.LoadBalancerSubnetMapping>[] | undefined>;
    /**
     * A list of subnets to attach to the LB. Only one of [subnets], [subnetIds] or [subnetMappings] can be specified
     */
    subnets?: pulumi.Input<pulumi.Input<pulumiAws.ec2.Subnet>[] | undefined>;
    /**
