...
type SubnetNamingStrategy string

const (
	// Suffix each subnet with the 1-based index of its availability zone, e.g. `vpc-public-1`, `vpc-public-2`.
	SubnetNamingStrategyLegacy = SubnetNamingStrategy("Legacy")
	// Suffix each subnet with the availability zone it is created in, e.g. `vpc-public-1a`, `vpc-public-1b`.
	SubnetNamingStrategyAvailabilityZone = SubnetNamingStrategy("AvailabilityZone")
)

func (SubnetNamingStrategy) ElementType() reflect.Type {
	return reflect.TypeOf((*SubnetNamingStrategy)(nil)).Elem()
}

func (e SubnetNamingStrategy) ToSubnetNamingStrategyOutput() SubnetNamingStrategyOutput {
	return pulumi.ToOutput(e).(SubnetNamingStrategyOutput)
}

func (e SubnetNamingStrategy) ToSubnetNamingStrategyOutputWithContext(ctx context.Context) SubnetNamingStrategyOutput {
	return pulumi.ToOutputWithContext(ctx, e).(SubnetNamingStrategyOutput)
}

func (e SubnetNamingStrategy) ToSubnetNamingStrategyPtrOutput() SubnetNamingStrategyPtrOutput {
	return e.ToSubnetNamingStrategyPtrOutputWithContext(context.Background())
}

func (e SubnetNamingStrategy) ToSubnetNamingStrategyPtrOutputWithContext(ctx context.Context) SubnetNamingStrategyPtrOutput {
	return SubnetNamingStrategy(e).ToSubnetNamingStrategyOutputWithContext(ctx).ToSubnetNamingStrategyPtrOutputWithContext(ctx)
}

func (e SubnetNamingStrategy) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e SubnetNamingStrategy) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e SubnetNamingStrategy) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e SubnetNamingStrategy) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type SubnetNamingStrategyOutput struct{ *pulumi.OutputState }

func (SubnetNamingStrategyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*SubnetNamingStrategy)(nil)).Elem()
}

func (o SubnetNamingStrategyOutput) ToSubnetNamingStrategyOutput() SubnetNamingStrategyOutput {
	return o
}

func (o SubnetNamingStrategyOutput) ToSubnetNamingStrategyOutputWithContext(ctx context.Context) SubnetNamingStrategyOutput {
	return o
}

func (o SubnetNamingStrategyOutput) ToSubnetNamingStrategyPtrOutput() SubnetNamingStrategyPtrOutput {
	return o.ToSubnetNamingStrategyPtrOutputWithContext(context.Background())
}

func (o SubnetNamingStrategyOutput) ToSubnetNamingStrategyPtrOutputWithContext(ctx context.Context) SubnetNamingStrategyPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v SubnetNamingStrategy) *SubnetNamingStrategy {
		return &v
	}).(SubnetNamingStrategyPtrOutput)
}

func (o SubnetNamingStrategyOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o SubnetNamingStrategyOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e SubnetNamingStrategy) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o SubnetNamingStrategyOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o SubnetNamingStrategyOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e SubnetNamingStrategy) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type SubnetNamingStrategyPtrOutput struct{ *pulumi.OutputState }

func (SubnetNamingStrategyPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**SubnetNamingStrategy)(nil)).Elem()
}

func (o SubnetNamingStrategyPtrOutput) ToSubnetNamingStrategyPtrOutput() SubnetNamingStrategyPtrOutput {
	return o
}

func (o SubnetNamingStrategyPtrOutput) ToSubnetNamingStrategyPtrOutputWithContext(ctx context.Context) SubnetNamingStrategyPtrOutput {
	return o
}

func (o SubnetNamingStrategyPtrOutput) Elem() SubnetNamingStrategyOutput {
	return o.ApplyT(func(v *SubnetNamingStrategy) SubnetNamingStrategy {
		if v != nil {
			return *v
		}
		var ret SubnetNamingStrategy
		return ret
	}).(SubnetNamingStrategyOutput)
}

func (o SubnetNamingStrategyPtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o SubnetNamingStrategyPtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *SubnetNamingStrategy) *string {
		if e == nil {
			return nil
		}
...
// SubnetNamingStrategyInput is an input type that accepts values of the SubnetNamingStrategy enum
// A concrete instance of `SubnetNamingStrategyInput` can be one of the following:
//
//	SubnetNamingStrategyLegacy
//	SubnetNamingStrategyAvailabilityZone
type SubnetNamingStrategyInput interface {
	pulumi.Input

	ToSubnetNamingStrategyOutput() SubnetNamingStrategyOutput
	ToSubnetNamingStrategyOutputWithContext(context.Context) SubnetNamingStrategyOutput
}

var subnetNamingStrategyPtrType = reflect.TypeOf((**SubnetNamingStrategy)(nil)).Elem()

type SubnetNamingStrategyPtrInput interface {
	pulumi.Input

	ToSubnetNamingStrategyPtrOutput() SubnetNamingStrategyPtrOutput
	ToSubnetNamingStrategyPtrOutputWithContext(context.Context) SubnetNamingStrategyPtrOutput
}

type subnetNamingStrategyPtr string

func SubnetNamingStrategyPtr(v string) SubnetNamingStrategyPtrInput {
	return (*subnetNamingStrategyPtr)(&v)
}

func (*subnetNamingStrategyPtr) ElementType() reflect.Type {
	return subnetNamingStrategyPtrType
}

func (in *subnetNamingStrategyPtr) ToSubnetNamingStrategyPtrOutput() SubnetNamingStrategyPtrOutput {
	return pulumi.ToOutput(in).(SubnetNamingStrategyPtrOutput)
}

func (in *subnetNamingStrategyPtr) ToSubnetNamingStrategyPtrOutputWithContext(ctx context.Context) SubnetNamingStrategyPtrOutput {
	return pulumi.ToOutputWithContext(ctx, in).(SubnetNamingStrategyPtrOutput)
}
...
type VpcEndpointStrategy string

const (
	// Pass VPC endpoint specs through without inferring generated VPC subnet or route table IDs.
	VpcEndpointStrategyLegacy = VpcEndpointStrategy("Legacy")
	// Fill omitted VPC endpoint fields from resources generated by this VPC component.
	VpcEndpointStrategyAuto = VpcEndpointStrategy("Auto")
)

func (VpcEndpointStrategy) ElementType() reflect.Type {
	return reflect.TypeOf((*VpcEndpointStrategy)(nil)).Elem()
}

func (e VpcEndpointStrategy) ToVpcEndpointStrategyOutput() VpcEndpointStrategyOutput {
	return pulumi.ToOutput(e).(VpcEndpointStrategyOutput)
}

func (e VpcEndpointStrategy) ToVpcEndpointStrategyOutputWithContext(ctx context.Context) VpcEndpointStrategyOutput {
	return pulumi.ToOutputWithContext(ctx, e).(VpcEndpointStrategyOutput)
}

func (e VpcEndpointStrategy) ToVpcEndpointStrategyPtrOutput() VpcEndpointStrategyPtrOutput {
	return e.ToVpcEndpointStrategyPtrOutputWithContext(context.Background())
}

func (e VpcEndpointStrategy) ToVpcEndpointStrategyPtrOutputWithContext(ctx context.Context) VpcEndpointStrategyPtrOutput {
	return VpcEndpointStrategy(e).ToVpcEndpointStrategyOutputWithContext(ctx).ToVpcEndpointStrategyPtrOutputWithContext(ctx)
}

func (e VpcEndpointStrategy) ToStringOutput() pulumi.StringOutput {
	return pulumi.ToOutput(pulumi.String(e)).(pulumi.StringOutput)
}

func (e VpcEndpointStrategy) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return pulumi.ToOutputWithContext(ctx, pulumi.String(e)).(pulumi.StringOutput)
}

func (e VpcEndpointStrategy) ToStringPtrOutput() pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringPtrOutputWithContext(context.Background())
}

func (e VpcEndpointStrategy) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return pulumi.String(e).ToStringOutputWithContext(ctx).ToStringPtrOutputWithContext(ctx)
}

type VpcEndpointStrategyOutput struct{ *pulumi.OutputState }

func (VpcEndpointStrategyOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*VpcEndpointStrategy)(nil)).Elem()
}

func (o VpcEndpointStrategyOutput) ToVpcEndpointStrategyOutput() VpcEndpointStrategyOutput {
	return o
}

func (o VpcEndpointStrategyOutput) ToVpcEndpointStrategyOutputWithContext(ctx context.Context) VpcEndpointStrategyOutput {
	return o
}

func (o VpcEndpointStrategyOutput) ToVpcEndpointStrategyPtrOutput() VpcEndpointStrategyPtrOutput {
	return o.ToVpcEndpointStrategyPtrOutputWithContext(context.Background())
}

func (o VpcEndpointStrategyOutput) ToVpcEndpointStrategyPtrOutputWithContext(ctx context.Context) VpcEndpointStrategyPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v VpcEndpointStrategy) *VpcEndpointStrategy {
		return &v
	}).(VpcEndpointStrategyPtrOutput)
}

func (o VpcEndpointStrategyOutput) ToStringOutput() pulumi.StringOutput {
	return o.ToStringOutputWithContext(context.Background())
}

func (o VpcEndpointStrategyOutput) ToStringOutputWithContext(ctx context.Context) pulumi.StringOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e VpcEndpointStrategy) string {
		return string(e)
	}).(pulumi.StringOutput)
}

func (o VpcEndpointStrategyOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o VpcEndpointStrategyOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e VpcEndpointStrategy) *string {
		v := string(e)
		return &v
	}).(pulumi.StringPtrOutput)
...
type VpcEndpointStrategyPtrOutput struct{ *pulumi.OutputState }

func (VpcEndpointStrategyPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**VpcEndpointStrategy)(nil)).Elem()
}

func (o VpcEndpointStrategyPtrOutput) ToVpcEndpointStrategyPtrOutput() VpcEndpointStrategyPtrOutput {
	return o
}

func (o VpcEndpointStrategyPtrOutput) ToVpcEndpointStrategyPtrOutputWithContext(ctx context.Context) VpcEndpointStrategyPtrOutput {
	return o
}

func (o VpcEndpointStrategyPtrOutput) Elem() VpcEndpointStrategyOutput {
	return o.ApplyT(func(v *VpcEndpointStrategy) VpcEndpointStrategy {
		if v != nil {
			return *v
		}
		var ret VpcEndpointStrategy
		return ret
	}).(VpcEndpointStrategyOutput)
}

func (o VpcEndpointStrategyPtrOutput) ToStringPtrOutput() pulumi.StringPtrOutput {
	return o.ToStringPtrOutputWithContext(context.Background())
}

func (o VpcEndpointStrategyPtrOutput) ToStringPtrOutputWithContext(ctx context.Context) pulumi.StringPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, e *VpcEndpointStrategy) *string {
		if e == nil {
			return nil
		}
...
// VpcEndpointStrategyInput is an input type that accepts values of the VpcEndpointStrategy enum
// A concrete instance of `VpcEndpointStrategyInput` can be one of the following:
//
//	VpcEndpointStrategyLegacy
//	VpcEndpointStrategyAuto
type VpcEndpointStrategyInput interface {
	pulumi.Input

	ToVpcEndpointStrategyOutput() VpcEndpointStrategyOutput
	ToVpcEndpointStrategyOutputWithContext(context.Context) VpcEndpointStrategyOutput
}

var vpcEndpointStrategyPtrType = reflect.TypeOf((**VpcEndpointStrategy)(nil)).Elem()

type VpcEndpointStrategyPtrInput interface {
	pulumi.Input

	ToVpcEndpointStrategyPtrOutput() VpcEndpointStrategyPtrOutput
	ToVpcEndpointStrategyPtrOutputWithContext(context.Context) VpcEndpointStrategyPtrOutput
}

type vpcEndpointStrategyPtr string

func VpcEndpointStrategyPtr(v string) VpcEndpointStrategyPtrInput {
	return (*vpcEndpointStrategyPtr)(&v)
}

func (*vpcEndpointStrategyPtr) ElementType() reflect.Type {
	return vpcEndpointStrategyPtrType
}

func (in *vpcEndpointStrategyPtr) ToVpcEndpointStrategyPtrOutput() VpcEndpointStrategyPtrOutput {
	return pulumi.ToOutput(in).(VpcEndpointStrategyPtrOutput)
}

func (in *vpcEndpointStrategyPtr) ToVpcEndpointStrategyPtrOutputWithContext(ctx context.Context) VpcEndpointStrategyPtrOutput {
	return pulumi.ToOutputWithContext(ctx, in).(VpcEndpointStrategyPtrOutput)
}
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SubnetNamingStrategyInput)(nil)).Elem(), SubnetNamingStrategy("Legacy"))
	pulumi.RegisterInputType(reflect.TypeOf((*SubnetNamingStrategyPtrInput)(nil)).Elem(), SubnetNamingStrategy("Legacy"))
	...
	pulumi.RegisterInputType(reflect.TypeOf((*VpcEndpointStrategyPtrInput)(nil)).Elem(), VpcEndpointStrategy("Legacy"))
	...
	pulumi.RegisterOutputType(SubnetNamingStrategyOutput{})
	pulumi.RegisterOutputType(SubnetNamingStrategyPtrOutput{})
	...
	pulumi.RegisterOutputType(VpcEndpointStrategyPtrOutput{})
}
