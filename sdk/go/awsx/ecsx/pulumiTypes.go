...
type FargateServiceTaskDefinitionArgs struct {
	...
	//
	// Either [container] or [containers] must be provided.
	Containers map[string]TaskDefinitionContainerDefinitionInput `pulumi:"containers"`
	// The number of cpu units used by the task. If not provided, a default will be computed based on the cumulative needs specified by [containerDefinitions]
	...
	// The execution role that the Amazon ECS container agent and the Docker daemon can assume.
	// Will be created automatically if not defined.
	ExecutionRole *iam.DefaultRoleWithPolicyArgs `pulumi:"executionRole"`
	// An optional unique name for your task definition. If not specified, then a default will be created.
	...
	// A set of volume blocks that containers in your task may use.
	LogGroup *cloudwatch.DefaultLogGroupArgs `pulumi:"logGroup"`
	// The amount (in MiB) of memory used by the task.  If not provided, a default will be computed
	// based on the cumulative needs specified by [containerDefinitions]
	...
	// IAM role that allows your Amazon ECS container task to make calls to other AWS services.
	// Will be created automatically if not defined.
	TaskRole *iam.DefaultRoleWithPolicyArgs `pulumi:"taskRole"`
	// Configuration block for volumes that containers in your task may use. Detailed below.
...
// The execution role that the Amazon ECS container agent and the Docker daemon can assume.
// Will be created automatically if not defined.
func (o FargateServiceTaskDefinitionOutput) ExecutionRole() iam.DefaultRoleWithPolicyPtrOutput {
	return o.ApplyT(func(v FargateServiceTaskDefinition) *iam.DefaultRoleWithPolicy { return v.ExecutionRole }).(iam.DefaultRoleWithPolicyPtrOutput)
}
...
// A set of volume blocks that containers in your task may use.
func (o FargateServiceTaskDefinitionOutput) LogGroup() cloudwatch.DefaultLogGroupPtrOutput {
	return o.ApplyT(func(v FargateServiceTaskDefinition) *cloudwatch.DefaultLogGroup { return v.LogGroup }).(cloudwatch.DefaultLogGroupPtrOutput)
}
...
// Docker networking mode to use for the containers in the task. Valid values are `none`, `bridge`, `awsvpc`, and `host`.
func (o FargateServiceTaskDefinitionOutput) NetworkMode() pulumi.StringPtrOutput {
	return o.ApplyT(func(v FargateServiceTaskDefinition) *string { return v.NetworkMode }).(pulumi.StringPtrOutput)
}
...
// Set of launch types required by the task. The valid values are `EC2` and `FARGATE`.
func (o FargateServiceTaskDefinitionOutput) RequiresCompatibilities() pulumi.StringArrayOutput {
	return o.ApplyT(func(v FargateServiceTaskDefinition) []string { return v.RequiresCompatibilities }).(pulumi.StringArrayOutput)
}
...
// IAM role that allows your Amazon ECS container task to make calls to other AWS services.
// Will be created automatically if not defined.
func (o FargateServiceTaskDefinitionOutput) TaskRole() iam.DefaultRoleWithPolicyPtrOutput {
	return o.ApplyT(func(v FargateServiceTaskDefinition) *iam.DefaultRoleWithPolicy { return v.TaskRole }).(iam.DefaultRoleWithPolicyPtrOutput)
}
...
// The execution role that the Amazon ECS container agent and the Docker daemon can assume.
// Will be created automatically if not defined.
func (o FargateServiceTaskDefinitionPtrOutput) ExecutionRole() iam.DefaultRoleWithPolicyPtrOutput {
	return o.ApplyT(func(v *FargateServiceTaskDefinition) *iam.DefaultRoleWithPolicy {
		if v == nil {
			return nil
		}
		return v.ExecutionRole
	}).(iam.DefaultRoleWithPolicyPtrOutput)
}
...
// A set of volume blocks that containers in your task may use.
func (o FargateServiceTaskDefinitionPtrOutput) LogGroup() cloudwatch.DefaultLogGroupPtrOutput {
	return o.ApplyT(func(v *FargateServiceTaskDefinition) *cloudwatch.DefaultLogGroup {
		if v == nil {
			return nil
		}
		return v.LogGroup
	}).(cloudwatch.DefaultLogGroupPtrOutput)
}
...
// Docker networking mode to use for the containers in the task. Valid values are `none`, `bridge`, `awsvpc`, and `host`.
func (o FargateServiceTaskDefinitionPtrOutput) NetworkMode() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *FargateServiceTaskDefinition) *string {
		if v == nil {
			return nil
		}
...
// Set of launch types required by the task. The valid values are `EC2` and `FARGATE`.
func (o FargateServiceTaskDefinitionPtrOutput) RequiresCompatibilities() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *FargateServiceTaskDefinition) []string {
		if v == nil {
			return nil
		}
...
// IAM role that allows your Amazon ECS container task to make calls to other AWS services.
// Will be created automatically if not defined.
func (o FargateServiceTaskDefinitionPtrOutput) TaskRole() iam.DefaultRoleWithPolicyPtrOutput {
	return o.ApplyT(func(v *FargateServiceTaskDefinition) *iam.DefaultRoleWithPolicy {
		if v == nil {
			return nil
		}
