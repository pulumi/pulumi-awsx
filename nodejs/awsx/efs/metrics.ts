...
export namespace metrics {
    ...
    export interface EfsMetricChange extends cloudwatch.MetricChange {
        /**
     ...
     */
    export function burstCreditBalance(change?: EfsMetricChange) {
     ...
     */
    export function clientConnections(change?: EfsMetricChange) {
     ...
     */
    export function dataReadIOBytes(change?: EfsMetricChange) {
     ...
     * Valid statistics: Minimum, Maximum, Average, Sum, SampleCount
     */
    export function dataWriteIOBytes(change?: EfsMetricChange) {
     ...
     * Valid statistics: Minimum, Maximum, Average, Sum, SampleCount
     */
    export function metadataIOBytes(change?: EfsMetricChange) {
     ...
     * Units: Percent
     */
    export function percentIOLimit(change?: EfsMetricChange) {
     ...
     * Valid statistics: Minimum, Maximum, Average
     */
    export function permittedThroughput(change?: EfsMetricChange) {
     ...
     * Valid statistics: Minimum, Maximum, Average, Sum, SampleCount
     */
    export function totalIOBytes(change?: EfsMetricChange) {
