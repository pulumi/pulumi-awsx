...
export namespace metrics {
    ...
    export interface ApigatewayMetricChange extends cloudwatch.MetricChange {
        /**
     ...
     * Unit: Count
     */
    export function error4XX(change?: ApigatewayMetricChange) {
     ...
     * Unit: Count
     */
    export function error5XX(change?: ApigatewayMetricChange) {
     ...
     * corresponds to the Count metric (below).
     */
    export function cacheHitCount(change?: ApigatewayMetricChange) {
     ...
     * Unit: Count
     */
    export function cacheMissCount(change?: ApigatewayMetricChange) {
     ...
     * Unit: Count
     */
    export function count(change?: ApigatewayMetricChange) {
     ...
     * Unit: Milliseconds
     */
    export function integrationLatency(change?: ApigatewayMetricChange) {
     ...
     * Unit: Milliseconds
     */
    export function latency(change?: ApigatewayMetricChange) {
