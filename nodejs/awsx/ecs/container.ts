...
export interface Container {
     ...
     *
     * Specific Pulumi Resources can be passed in here to automatically assign a port mapping for
     * this container.  For example, an [awxs.lb.TargetGroup] or [awsx.lb.Listener] may be used.
     *
