...
export class Metric {
    ...
    public createAlarm(name: string, args: AlarmArgs, opts: pulumi.CustomResourceOptions = {}) {
        ...
        return new aws.cloudwatch.MetricAlarm(name, {
            ...
            period: this.period,
            statistic: this.statistic,
            unit: this.unit.apply(u => <string>u),
...
function validateStatistics(statistic: MetricStatistic | undefined, extendedStatistic: number | undefined) {
