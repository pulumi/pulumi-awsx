...
export namespace metrics {
    ...
    export interface SnsMetricChange extends cloudwatch.MetricChange {
        /**
     ...
     */
    export function numberOfMessagesPublished(change?: SnsMetricChange) {
     ...
     * Valid Statistics: Sum
     */
    export function numberOfNotificationsDelivered(change?: SnsMetricChange) {
     ...
     */
    export function numberOfNotificationsFailed(change?: SnsMetricChange) {
     ...
     * Valid Statistics: Sum, Average
     */
    export function numberOfNotificationsFilteredOut_NoMessageAttributes(change?: SnsMetricChange) {
     ...
     * Valid Statistics: Sum, Average
     */
    export function numberOfNotificationsFilteredOut_InvalidAttributes(change?: SnsMetricChange) {
     ...
     */
    export function publishSize(change?: SnsMetricChange) {
     ...
     */
    export function smsMonthToDateSpentUSD(change?: SnsMetricChange) {
     ...
     */
    export function smsSuccessRate(change?: SnsMetricChange) {
