...
func Test_Examples(t *testing.T) {
	...
	shortTests := []integration.ProgramTestOptions{
		...
		testBase.With(integration.ProgramTestOptions{
			Dir: path.Join(cwd, "./dashboards"),
		}),
		testBase.With(integration.ProgramTestOptions{
			Dir: path.Join(cwd, "./metrics"),
		}),
		testBase.With(integration.ProgramTestOptions{
			Dir:       path.Join(cwd, "./vpc"),
			StackName: addRandomSuffix("vpc"),
		}),
		testBase.With(integration.ProgramTestOptions{
			Dir:       path.Join(cwd, "./fargate"),
	...
	longTests := []integration.ProgramTestOptions{
		...
		// 		{
		// 			Additive: true,
		// 			Dir:      path.Join(cwd, "./ec2/update1"),
		// 		},
		// 		{
		// 			Additive:               true,
		// 			Dir:                    path.Join(cwd, "./ec2/update2"),
