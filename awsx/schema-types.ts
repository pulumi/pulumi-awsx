...
export interface VpcArgs {
    ...
    readonly region?: pulumi.Input<string>;
    readonly subnetNaming?: SubnetNamingStrategyInputs;
...
export interface ApplicationLoadBalancerArgs {
    ...
    readonly ipamPools?: pulumi.Input<aws.types.input.lb.LoadBalancerIpamPools>;
    readonly listener?: ListenerInputs;
    readonly listeners?: ListenerInputs[];
    readonly minimumLoadBalancerCapacity?: pulumi.Input<aws.types.input.lb.LoadBalancerMinimumLoadBalancerCapacity>;
    readonly name?: pulumi.Input<string>;
...
export interface BucketInputs {
    ...
    readonly logging?: pulumi.Input<aws.types.input.s3.BucketLogging>;
    readonly objectLockConfiguration?: pulumi.Input<aws.types.input.s3.BucketObjectLockConfiguration>;
    readonly objectLockEnabled?: pulumi.Input<boolean>;
...
export interface BucketOutputs {
    ...
    readonly logging?: pulumi.Output<aws.types.output.s3.BucketLogging>;
...
export type SubnetNamingStrategyInputs = "Legacy" | "AvailabilityZone";
export type SubnetNamingStrategyOutputs = "Legacy" | "AvailabilityZone";
